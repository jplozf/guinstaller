...
#-------------------------------------------------------------------------------
# openFileWithDefaultViewer()
#-------------------------------------------------------------------------------
def openFileWithDefaultViewer(filename):
    ...
    # subprocess.call(["cmd", "/c", "start", repr(filename)])
...
#---------------------------------------------------------------------------
# tagNameToString()
# Convert a tag name (ie "ORGANIZATION_NAME") to a lowercase string with first letter in upercase (ie "Organization Name")
#---------------------------------------------------------------------------
def tagNameToString(tag):
    l = tag.split('_')
    s = ""
    for x in l:
        x = x.lower()
